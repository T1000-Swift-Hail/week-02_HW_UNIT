...
var ahmed = Artist(name: "khaled", birthPlace: "taife", age: 40)
    do {
...
struct Doctor:Person {
    ...
    var description : String {
        return "my name is \(name) and I am from \(birthPlace)and  My age is\(age) and my specialty is\(specialization) " }
...
let Nora = Doctor(name: "NORA", birthPlace: "khobar", age: 36, specialization: "Internal" )
